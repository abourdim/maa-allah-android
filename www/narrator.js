/* ═══════════════════════════════════════════════════════════
   NARRATOR.JS — Audiobook narrator for Maa Allah
...
(function() {
  ...
  function onSpeedChange(val) {
    ...
    localStorage.setItem('ma-narrator-speed', STATE.speed);
  }
  ...
  function onPitchChange(val) {
    ...
    localStorage.setItem('ma-narrator-pitch', STATE.pitch);
  }
  ...
  function onKaraokeToggle(checked) {
    ...
    localStorage.setItem('ma-narrator-karaoke', checked);
  }

  function onAutoScrollToggle(checked) {
    STATE.autoScroll = checked;
    localStorage.setItem('ma-narrator-autoscroll', checked);
  }

  function onDuoToggle(checked) {
    STATE.duoReading = checked;
    localStorage.setItem('ma-narrator-duo', checked);
  }
  ...
  function loadSettings() {
    STATE.speed = parseFloat(localStorage.getItem('ma-narrator-speed')) || 1;
    STATE.pitch = parseFloat(localStorage.getItem('ma-narrator-pitch')) || 1;
    STATE.karaokeEnabled = localStorage.getItem('ma-narrator-karaoke') !== 'false';
    STATE.autoScroll = localStorage.getItem('ma-narrator-autoscroll') !== 'false';
    STATE.duoReading = localStorage.getItem('ma-narrator-duo') === 'true';
  }
